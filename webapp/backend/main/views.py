...
def bio_creator(request: HttpRequest) -> JsonResponse:
    ...
    prompt = f'Generate an attractive online dating bio with 20 to 35 words for a person with following description.' \
             f' If not enough information is given, generate a random bio. Only output the bio: {text}'
